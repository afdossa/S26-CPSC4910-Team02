...
export const About: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 bg-white dark:bg-slate-800 overflow-hidden shadow rounded-lg divide-y divide-gray-200 dark:divide-slate-700">
        <div className="px-4 py-5 sm:px-6 bg-slate-50 dark:bg-slate-700/50">
           <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">System Information</h3>
           <p className="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">Data retrieved from live database configuration.</p>
        </div>
        <div className="px-4 py-5 sm:p-6">
            <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                <div className="sm:col-span-1">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-white font-semibold">{data.teamNumber}</dd>
                </div>
                <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 flex items-center">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-white font-semibold">{data.versionNumber}</dd>
                </div>
                <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 flex items-center">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-white font-semibold">{data.releaseDate}</dd>
                </div>
                 <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 flex items-center">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-white font-semibold">{data.productName}</dd>
                </div>
                <div className="sm:col-span-2">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Description</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-white">{data.description}</dd>
                </div>
            </dl>
        </div>
      </div>
      ...
      <div className="mt-8 bg-white dark:bg-slate-800 shadow rounded-lg p-6 border-t-4 border-indigo-500">
